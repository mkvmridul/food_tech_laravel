        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="card-top">
                            <img src="/assets/images/user.png" class="card-img-top" alt="" style="width: 10%; border-radius: 50%;">
                            <h4 class="d-inline ml-3">Welcome <span class="text-primary">{{ucfirst(Auth::user()->name)}}</span> </h4>
                            <br>
                        </div>
                        <br>
                        <br>
